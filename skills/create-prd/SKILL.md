...
1. **CRITICAL** -- 先读取 `../lark/lark-shared/SKILL.md` 完成认证检查
2. 读取 `../lark/lark-doc/SKILL.md` 了解文档创建指南
3. 读取 `../lark/lark-doc/references/lark-doc-create.md` 了解 `docs +create` 的完整参数和 Lark-flavored Markdown 语法
...
7. 如果文档中包含空白画板（`board_tokens` 不为空）：
   - 读取 `../lark/lark-whiteboard/SKILL.md`
