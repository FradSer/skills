...
> **前置条件：** 先阅读 [`../lark-shared/lark-shared.md`](../lark-shared/lark-shared.md) 了解认证、身份切换和安全规则。
...
- [lark-skill-maker](../lark-skill-maker/lark-skill-maker.md) — 如需将挖掘到的 API 固化为新 Skill
