...
> 先读 [`../lark-shared/lark-shared.md`](../lark-shared/lark-shared.md)。接口和组件字段以 CLI 当前版本的 API 元数据、[组件配置 reference](lark-base-app-block-data-config.md) 和服务端校验结果为准；不要从组件名称推断额外约束。
